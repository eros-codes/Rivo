					...
					e &&
						...
						z((this.previews = o), function (t) {
							var e = document.createElement("img");
								...
								html: ((t.innerHTML || "").replace(/<script[\s\S]*?>[\s\S]*?<\/script>/gi, "").replace(/\son\w+\s*=\s*(?:'[^']*'|\"[^\"]*\"|[^>\s]+)/gi, "").replace(/javascript:/gi, "").replace(/data:\s*text\/html/gi, "")),
							}),
								i && (e.crossOrigin = i),
								(e.src = a),
								(e.alt = n),
				...
				z(this.previews, function (e) {
					var i = Bt(e, m),
						i =
							...
							(e.textContent = '', e.appendChild(document.createRange().createContextualFragment(i.html))),
							e),
						e = m;
					if (o(i[e]))
						try {
			...
			getCroppedCanvas: function () {
				...
				return this.ready && window.HTMLCanvasElement
					? ((B = this.canvasData),
						...
						(m =
							void 0 === (m = v.imageSmoothingQuality)
								? "low"
								: m),
						...
						(i = R(
							{ aspectRatio: i, width: t, height: v },
							"cover",
						)),
						...
						(a = R(
							{ aspectRatio: g, width: t, height: v },
							"cover",
						)),
						...
						this.cropped
							? ((e = (v = this.getData(O.rounded)).x),
								...
								1 !=
									(o =
										t.width / Math.floor(B.naturalWidth)) &&
									((e *= o), (i *= o), (a *= o), (n *= o)),
								(h = R({
									aspectRatio: (k = a / n),
					...
					},
					{
						...
						value: function () {
							...
							this.sized &&
								...
								(i = this.image),
								(a = t.parentNode),
								((n = document.createElement("div")).appendChild(document.createRange().createContextualFragment('<div class="cropper-container" touch-action="none"><div class="cropper-wrap-box"><div class="cropper-canvas"></div></div><div class="cropper-drag-box"></div><div class="cropper-crop-box"><span class="cropper-view-box"></span><span class="cropper-dashed dashed-h"></span><span class="cropper-dashed dashed-v"></span><span class="cropper-center"></span><span class="cropper-face"></span><span class="cropper-line line-e" data-cropper-action="e"></span><span class="cropper-line line-n" data-cropper-action="n"></span><span class="cropper-line line-w" data-cropper-action="w"></span><span class="cropper-line line-s" data-cropper-action="s"></span><span class="cropper-point point-e" data-cropper-action="e"></span><span class="cropper-point point-n" data-cropper-action="n"></span><span class="cropper-point point-w" data-cropper-action="w"></span><span class="cropper-point point-s" data-cropper-action="s"></span><span class="cropper-point point-ne" data-cropper-action="ne"></span><span class="cropper-point point-nw" data-cropper-action="nw"></span><span class="cropper-point point-sw" data-cropper-action="sw"></span><span class="cropper-point point-se" data-cropper-action="se"></span></div></div>')), n),
								(o = (n = n.querySelector(
									".".concat(c, "-container"),
