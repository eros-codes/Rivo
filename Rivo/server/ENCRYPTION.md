...
--------------
- می‌خواهی من:
  - KEKهای واقعی را به Vault انتقال دهم و سپس چرخش را روی دیتابیس واقعی اجرا کنم؟ (نیاز به دسترسی Vault و backup)
  - mock Vault و اسکریپت‌های تست را پاک/آرشیو کنم تا repo تمیز شود؟

این صفحه فشرده برای مرجع سریع است؛ اگر مایل باشی مستندات را به انگلیسی، یا با مثال‌های AWS KMS/GCP KMS/Azure Key Vault گسترش بدهم، بگو تا اضافه کنم.
